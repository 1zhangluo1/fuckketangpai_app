...
part 'sign_repeatedly.g.dart';

@JsonSerializable(explicitToJson: true)
class SignRepeatedly {
  ...
  factory SignRepeatedly.fromJson(Map<String, dynamic> json) => _$SignRepeatedlyFromJson(json);
  
  Map<String, dynamic> toJson() => _$SignRepeatedlyToJson(this);
  
  factory SignRepeatedly.emptyInstance() => SignRepeatedly(status: 0, code: 0, message: "", data: Data.emptyInstance());
}
